...
#just day 1, neonic (and social cue) on blue bias
...
#Donna Maney's Anovas
You will want to reconsider some claims that are currently not supported by your data analysis. Specifically, you say that the bees used the social cues. We don’t currently have evidence of that, at least that I could find in the paper. To show that the bees are using social cues on day 1, you'll need to show that the honest bees are making more visits to the rewarded flowers than the control group, and/or the misled bees are making fewer. I would do a one-way ANOVA on the day 1 data, with social cue (3 levels) as the fixed factor and preference for the rewarded flower as the response variable. Then, if  you find a significant effect of social cue on preference, you would perform pairwise tests (control vs. honest and control vs. misleading). Just looking at the graphs, it’s possible you might have an effect for Study 1 but it does not look like the bees in Study 2 are using the cues. It seems like a big problem that the honest-cued bees are not preferring the rewarded flowers as much as the control bees.
```{r}
